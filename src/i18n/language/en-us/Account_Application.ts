export const Account_Application = {
  ...
  contentTitle: "Permission Management",
  ...
  customerEnterpriseProductQuotation:
    "Featured product quotation includes components, solutions and final products",
  customerEnterpriseCustomizedService:
    "Customization service quotation regarding components, solutions and final products",
