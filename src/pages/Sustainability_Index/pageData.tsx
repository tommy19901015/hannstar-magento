    ...
    module5: [
      {
        titleContent: {
          ...
          content:
            "2021年永續報告書依循國際原則導入和揭露TCFD及SASB指標資訊，深化並聚焦永續資訊之揭露，回應利害關係人關心的議題，創造長期永續價值。",
        },
        video: {
      ...
      },
      {
        titleContent: {
          title: "紀錄，不安中的勇氣",
          content:
            "從全球到台灣，2020年充斥著動盪不安的危機。本紀錄片記錄著面對COVID－19疫情嚴峻考驗下，從一個您從未看過的角度，闡述在這場戰爭中，每一步決策都將是深刻印在心裡的一段歷史。",
        },
        video: {
          src: `${urlConfig.s3Url}/Media/Hannstar%E4%B8%80%E5%88%86%E5%8D%8A%E5%BD%A2%E8%B1%A1%E5%BD%B1%E7%89%871106_final.mov`,
        },
