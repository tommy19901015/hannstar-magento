...
const ServiceGreenServiceApply: React.FC = () => {
  ...
  const greenServiceTable = useGreenServiceApply()

  const breadcrumbsData = greenServiceTable.breadcrumbs;
  const formProps1 = greenServiceTable.formProps1;
  const formProps2= greenServiceTable.formProps2;
  const formProps3= greenServiceTable.formProps3;
  const handlerReset = () => { };
  const handlerSubmit = () => { };
