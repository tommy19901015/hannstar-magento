  ...
  const PageType: I_TemplateLayout = {
    props: [
      ...
      },
      {
        ...
        data: [
          {
            src: `${urlConfig.s3Url}/Image/hannstar/index/img_hsd_index_pd_banner_main.jpg`,
            title: "顯示紙",
        ...
        data: [
          {
            ...
            data: [
              {
                src: `${urlConfig.s3Url}/Image/hannstar/index/img_hsd_index_pd_banner_skill.jpg`,
                title: "顯示紙技術",
              ...
              {
                src: `${urlConfig.s3Url}/Image/hannstar/index/img_hsd_index_pd_banner_buy.jpg`,
                title: "顯示紙產品選購",
              ...
              {
                src: `${urlConfig.s3Url}/Image/hannstar/index/img_hsd_index_pd_banner_ef.jpg`,
                title: "綠色永續設計",
      ...
      },
      {
        ...
        data: [
          {
            src: `${urlConfig.s3Url}/Image/hannstar/index/img_hsd_index_pd_banner_application.jpg`,
            title: "探索顯示紙多元應用",
            content:
      ...
      },
      {
        ...
        data: [
          {
            src: `${urlConfig.s3Url}/Image/hannstar/index/career_banner.jpg`,
            title: "瀚宇彩晶人才招募",
      ...
      },
      {
        ...
        data: [
          {
            src: `${urlConfig.s3Url}/Image/hannstar/index/esg_banner.jpg`,
        ...
        data: [
          {
            ...
            imgGrids: [
              {
                text: "瀚宇彩晶",
                src: `${urlConfig.s3Url}/Image/hannstar/index/btn_hsd_index_rc_hss.png`,
              },
              {
                text: "和鑫光電",
                src: `${urlConfig.s3Url}/Image/hannstar/index/btn_hsd_index_rc_hst.png`,
              },
              {
                text: "瀚斯寶麗",
                src: `${urlConfig.s3Url}/Image/hannstar/index/btn_hsd_index_rc_hsp.png`,
              },
              {
                text: "瀚寓酒店",
                src: `${urlConfig.s3Url}/Image/hannstar/index/btn_hsd_index_rc_hsh.png`,
              },
              {
                text: "彩晶文教基金會",
                src: `${urlConfig.s3Url}/Image/hannstar/index/btn_hsd_index_rc_hsf.png`,
              },
            ],
          },
        ],
