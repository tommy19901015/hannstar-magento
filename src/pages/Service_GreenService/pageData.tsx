            ...
            data: [
              {
                title: "綠色環保申請",
                content:
                  "對於人類健康與環境安全保護彩晶一直致力於降低產品對環境及人類的影響。為實踐對環境改善、污染防治等環安政策之承諾，以降低產品對環境衝擊與減少危害物質擴散，符合法規規定與客戶要求並提升產品環保性能。液晶顯示器是高科技的產品，體積小、重量輕、可節約能源、低電磁波幅射、無鉛、無有害物質，完全合乎全球綠色環保的潮流。",
              },
            ],
          },
        {
