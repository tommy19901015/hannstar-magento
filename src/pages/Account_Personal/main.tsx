        ...
        <form onSubmit={handleSubmit(onSubmit)}>
            ...
            <div className="classificationBlock">
                ...
                <div className="row">
                  ...
                  <PhoneInput
                    country={"tw"}
                    value={phoneCode}
                    {...register("CellPhoneNumber2", { required: true })}
                    onChange={(value, data) => handlePhoneCall(value, data)}
                  />
                  {errors.CellPhoneNumber2 && <span>必填欄位，請重新輸入</span>}
                  </div>
                 <div className="col-2">
                 <label className="required">分機</label>
                  <input type="text" defaultValue="" {...register("PhoneNumber1", { required: true })} />
          ...
          <div className="classificationBlock">
                ...
                <label className="required">商業類型</label>
                  <input type="text" defaultValue="" {...register("BusinessType", { required: true })} />
                ...
                <label className="required">國家/地區</label>
                  <input type="text" defaultValue="" {...register("Country", { required: true })} />
