        ...
        <form onSubmit={handleSubmit(onSubmit)}>
          ...
          <div className="stepTitle">步驟 2. 申請人資訊</div>
                  ...
                  (item,i) => (
                      <>
                        <label key={item.value}>
                          <input type="checkbox" value={item.value} {...register("InterestedType")}/>
                          {item.text}
                        </label>
                      </>
                    )
            ...
            <div className="classificationBlock">
                ...
                <option value={formData.BusinessType.option[3].value}>{formData.BusinessType.option[3].text}</option>
                <option value={formData.BusinessType.option[4].value}>{formData.BusinessType.option[4].text}</option>
                <option value={formData.BusinessType.option[0].value}>{formData.BusinessType.option[5].text}</option>
                <option value={formData.BusinessType.option[6].value}>{formData.BusinessType.option[6].text}</option>
                  </select>
                ...
                <div className="col-2">
                  ...
                  <select {...register("CompanyEmpNumber", { required: true })} >
                    ...
                    <option value={formData.CompanyEmpNumber.option[2].value}>{formData.CompanyEmpNumber.option[0].text}</option>
                    </select>
                ...
                <div className="checkbox-col">
                {
                formData.CompanyMA1.option.map(
                  (item,i) => (
                      <>
                        <label key={item.value}>
                          <input type="checkbox" value={item.value} {...register("CompanyMA1")}/>
                          {item.text}
                        </label>
                      </>
                    )
            ...
            <div className="classificationBlock">
              <div className="row">
                ...
                <label className="required">購買渠道-1</label>
                  <input type="text" className="mb-20" defaultValue="" {...register("Buy1", { required: true })} />
                  {errors.Buy1 && <span>必填欄位，請重新輸入</span>}
                  <label className="required">購買渠道-1</label>
                  <input type="text" className="mb-20" defaultValue="" {...register("Buy2", { required: true })} />
                  {errors.Buy2 && <span>必填欄位，請重新輸入</span>}
                  <label className="required">購買渠道-1</label>
                  <input type="text" className="mb-20" defaultValue="" {...register("Buy3", { required: true })} />
