          ...
          <div className="stepTitle">步驟 2. 申請人資訊</div>
            <div className="classificationBlock">
                <div className="row">
                  ...
                  <select {...register("JobAttributes")} >
                    <option value={formData.JobAttributes.option[0].value}>{formData.JobAttributes.option[0].text}</option>
                    <option value={formData.JobAttributes.option[1].value}>{formData.JobAttributes.option[1].text}</option>
                    <option value={formData.JobAttributes.option[2].value}>{formData.JobAttributes.option[2].text}</option>
                  </select>
                  ...
                  <select {...register("JobTitle")} >
                    <option value={formData.JobTitle.option[0].value}>{formData.JobTitle.option[0].text}</option>
                    <option value={formData.JobTitle.option[1].value}>{formData.JobTitle.option[1].text}</option>
                    <option value={formData.JobTitle.option[2].value}>{formData.JobTitle.option[0].text}</option>
                  </select>
                ...
                <div className="row">
                 ...
                 <label className="required">分機</label>
                  <input type="text" defaultValue="" {...register("PhoneNumber2", { required: true })} />
                ...
                <div className="checkbox-col flex-wrap">
                {
                formData.InterestedType.option.map(
                  (item,i) => (
                      <>
                        <label key={item.value} className="label-w">
                          <input className="hannstarCheckBox" type="checkbox" value={item.value} {...register("InterestedType")}/>
                          {item.text}
                        </label>
                      </>
                    )
            ...
            <div className="classificationBlock">
                ...
                <label className="required">公司名稱</label>
                  <input type="text" defaultValue="" {...register("CompanyName", { required: true })} />
                  {errors.CompanyName && <span>必填欄位，請重新輸入</span>}
                </div>
                <div className="col-2">
                <label className="required">公司名稱關鍵字</label>
                  <input type="text" defaultValue="" {...register("CompanySName", { required: true })} />
                ...
                <label className="required">企業編號(統編/稅號)</label>
                  <input type="text" defaultValue="" {...register("TaxNo", { required: true })} />
                ...
                <option value={formData.BusinessType.option[0].value}>{formData.BusinessType.option[0].text}</option>
                <option value={formData.BusinessType.option[1].value}>{formData.BusinessType.option[1].text}</option>
                <option value={formData.BusinessType.option[2].value}>{formData.BusinessType.option[2].text}</option>
               </select>
                ...
                <div className="row">
                  ...
                  <select {...register("ApplicableArea")}>
                    <option value={formData.ApplicableArea.option[0].value}>{formData.ApplicableArea.option[0].text}</option>
                    <option value={formData.ApplicableArea.option[1].value}>{formData.ApplicableArea.option[1].text}</option>
                    <option value={formData.ApplicableArea.option[2].value}>{formData.ApplicableArea.option[2].text}</option>
                    <option value={formData.ApplicableArea.option[3].value}>{formData.ApplicableArea.option[3].text}</option>
                    <option value={formData.ApplicableArea.option[4].value}>{formData.ApplicableArea.option[4].text}</option>
                  </select>
                  </div>
                </div>
                <div className="row">
                  ...
                  <input type="text" defaultValue="" {...register("Weblink", { required: true })} />
                ...
                <div className="row">
                  ...
                  <select {...register("Country" ,{ required: true })} >
                    <option value={formData.Country.option[0].value}>{formData.Country.option[0].text}</option>
                    <option value={formData.Country.option[1].value}>{formData.Country.option[1].text}</option>
                  </select>
                    {errors.Country && <span>必填欄位，請重新輸入</span>}
                  </div>
                  <div className="col-3">
                  <label className="required">城市</label>
                    <input type="text" defaultValue="" {...register("AreaCity", { required: true })} />
                    {errors.AreaCity && <span>必填欄位，請重新輸入</span>}
                    </div>
                    <div className="col-3">
                    <label className="required">地址</label>
                    <input type="text" defaultValue="" {...register("AreaAddress", { required: true })} />
                ...
                <div className="col-2">
                  ...
                  <select {...register("CompanyEmpNumber", { required: true })} >
                    <option value={formData.CompanyEmpNumber.option[0].value}>{formData.CompanyEmpNumber.option[0].text}</option>
                    <option value={formData.CompanyEmpNumber.option[1].value}>{formData.CompanyEmpNumber.option[1].text}</option>
                    <option value={formData.CompanyEmpNumber.option[2].value}>{formData.CompanyEmpNumber.option[2].text}</option>
                    <option value={formData.CompanyEmpNumber.option[3].value}>{formData.CompanyEmpNumber.option[3].text}</option>
                    </select>
                ...
                <div className="col-2">
                  ...
                  <select {...register("TechnicalStaff", { required: true })} >
                    <option value={formData.TechnicalStaff.option[0].value}>{formData.TechnicalStaff.option[0].text}</option>
                    <option value={formData.TechnicalStaff.option[1].value}>{formData.TechnicalStaff.option[1].text}</option>
                    <option value={formData.TechnicalStaff.option[2].value}>{formData.TechnicalStaff.option[2].text}</option>
                    <option value={formData.TechnicalStaff.option[3].value}>{formData.TechnicalStaff.option[3].text}</option>
                    </select>
                ...
                <div className="col-2">
                  ...
                  <select {...register("AnnualRevenue", { required: true })} >
                    <option value={formData.AnnualRevenue.option[0].value}>{formData.AnnualRevenue.option[0].text}</option>
                    <option value={formData.AnnualRevenue.option[1].value}>{formData.AnnualRevenue.option[1].text}</option>
                    <option value={formData.AnnualRevenue.option[2].value}>{formData.AnnualRevenue.option[2].text}</option>
                    <option value={formData.AnnualRevenue.option[3].value}>{formData.AnnualRevenue.option[3].text}</option>
                    <option value={formData.AnnualRevenue.option[4].value}>{formData.AnnualRevenue.option[4].text}</option>
                    </select>
                  {errors.AnnualRevenue && <span>必填欄位，請重新輸入</span>}
                </div>
                <div className="col-2">
                <label className="required">上市公司</label>
                  <select {...register("CompanyStockOn", { required: true })} >
                    <option value={formData.CompanyStockOn.option[0].value}>{formData.CompanyStockOn.option[0].text}</option>
                    <option value={formData.CompanyStockOn.option[1].value}>{formData.CompanyStockOn.option[1].text}</option>
                    </select>
                ...
                <label className="required">主要出貨客戶-1</label>
                  <input type="text" defaultValue="" {...register("TOP1",{ required: true })} />
                  {errors.TOP1 && <span>必填欄位，請重新輸入</span>}
                </div>
                <div className="col-3">
                <label className="required">主要出貨客戶-2</label>
                  <input type="text" defaultValue="" {...register("TOP2", { required: true })} />
                  {errors.TOP2 && <span>必填欄位，請重新輸入</span>}
                </div>
                <div className="col-3">
                <label className="required">主要出貨客戶-3</label>
                  <input type="text" defaultValue="" {...register("TOP3", { required: true })} />
            ...
            <div className="row">
                ...
                {
                  formData.HannstarYN.option.map(
                    (item,i) => (
                        <>
                          <label key={item.value}>
                            <input type="radio" value={item.value} {...register("HannstarYN")}/>
                            {item.text}
                          </label>
                        </>
                      )
                ...
                <div className="col-2">
                  <label className="required">請在提供HannStar供應商代碼(6碼)</label>
                  <input type="text" className="" defaultValue="" {...register("hannstarCode", { required: true })} />
                  {errors.hannstarCode && <span>必填欄位，請重新輸入</span>}
                </div>
              </div>
              <div className="row">
                <div className="col-2">
            ...
            <div className="row">
                ...
                <input type="text" className="companyRemark" defaultValue="" {...register("CompanyRemark", { required: true })} />
