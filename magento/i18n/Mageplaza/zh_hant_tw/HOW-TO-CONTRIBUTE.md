...
- We will merge `github_contributions.csv` with [zh_TW.csv](https://github.com/mageplaza/magento-2-chinese-taiwan-language-pack/blob/master/zh_TW.csv). Your Magento 2 store will use this csv file.
...
#### Suggestions
- You can copy any part of `zh_TW.csv` and paste to `github_contributions.csv` then translate it.
- Please do not copy all lines in `zh_TW.csv`, we will not approve it in this case.
